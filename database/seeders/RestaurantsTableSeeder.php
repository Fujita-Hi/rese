...
class RestaurantsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        'url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
        'name' => '戦慄',
        ...
        'url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
        'name' => 'ルーク',
        ...
        'url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
        'name' => '香',
